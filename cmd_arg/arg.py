...
async def parse_cmd():
    ...
    parser.add_argument('--type', type=str, help='crawler type (search | detail | creator | collection)',
                        choices=["search", "detail", "creator", "collection"], default=config.CRAWLER_TYPE)
